export const TestApiUrls = {
  ...
  searchLocationsGet: (inputValue) => `https://eu1.locationiq.com/v1/search.php?keyr=${process.env.REACT_APP_LOCATION_IQ_TOKEN}&countrycodes=MK&city=${inputValue}&format=json`
}